"""Training script for ResNet1D-14 with LOS bin classification.
...
def main():
    """Main training function for 24h dataset with class weights (sqrt method)."""
    ...
    print("="*60)
    print("Training ResNet1D-14 with Pretrained Weights and Class Weights (SQRT) for 24h Dataset")
    print("="*60)
