...
def main():
    """Main training function for 24h dataset with class weights (sqrt method, training from scratch)."""
    ...
    print("="*60)
    print("Training ResNet1D-14 from Scratch with Class Weights (SQRT) for 24h Dataset")
    print("="*60)
