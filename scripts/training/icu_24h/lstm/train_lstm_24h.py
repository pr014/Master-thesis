"""Training script for LSTM1D Unidirectional with LOS regression.

LOS Regression Task: Predicts continuous LOS in days (not binned classes).
Uses data augmentation but no demographic features.

Usage:
  python scripts/training/icu_24h/lstm/train_lstm_24h.py
  python .../train_lstm_24h.py --model-config configs/model/lstm/unidirectional/lstm_2layer.yaml
  MODEL_CONFIG_PATH=.../lstm_1layer.yaml python .../train_lstm_24h.py
"""
...
from src.models.lstm import LSTM1D_Unidirectional
...
def main():
    ...
    parser.add_argument(
        ...
        default=os.getenv(
            "MODEL_CONFIG_PATH",
            "configs/model/lstm/unidirectional/lstm_1layer.yaml",
        ),
