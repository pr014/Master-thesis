...
Config: configs/all_icu_ecgs/weighted/sqrt_weights.yaml (SQRT method)
"""
...
def main():
    """Main training function for all_icu_ecgs dataset with SQRT class weights."""
    # Load configs - using all_icu_ecgs weighted config (SQRT method)
    base_config_path = Path("configs/all_icu_ecgs/weighted/sqrt_weights.yaml")
    ...
    print("="*60)
    print("Training CNN with Class Weights for All ICU ECGs Dataset (SQRT Method)")
    print("="*60)
